...
export const HeroSection = () => {
  ...
  return (
    <section 
      className="relative w-full h-[90vh] min-h-[650px] flex items-center justify-center px-6 overflow-hidden bg-center bg-no-repeat"
      style={{ 
    ...
    >
      ...
      <div className="relative z-10 max-w-[1000px] w-full bg-[#FAF6F0]/70 backdrop-blur-lg border border-white/60 p-10 md:p-14 rounded-[32px] shadow-[0_30px_70px_rgba(28,28,28,0.1)] space-y-8 text-center transition-all duration-500 hover:shadow-[0_35px_80px_rgba(28,28,28,0.14)]">
        ...
        <h1 
          className="font-poppins text-3xl sm:text-4xl md:text-[44px] lg:text-[48px] font-bold text-[#1C1C1C] mx-auto"
          style={{ maxWidth: '900px', lineHeight: '1.1', letterSpacing: '-0.03em' }}
        >
        ...
        <p className="text-[#4C4C4C] text-xs md:text-sm leading-relaxed max-w-md mx-auto font-inter font-light">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2 w-full max-w-xs sm:max-w-none mx-auto">
          ...
          <motion.button 
            ...
            className="w-full sm:w-56 h-14 bg-[#1F1F1F] text-white font-poppins font-bold text-xs uppercase tracking-wider rounded-xl flex items-center justify-center gap-2.5 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900 focus:ring-offset-white"
